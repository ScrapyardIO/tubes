...
* [Panel factory](core/panel-factory.md) - Fluent `Panel::wrap` / `circuit` / `profile` → PanelIC. (`draft`)
* [SupportsPartialRefresh](core/supports-partial-refresh.md) - Contracts/Core marker; CPU PARTIAL present. (`draft`)
