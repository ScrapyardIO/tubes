...
* [WindowManager](window-manager.md) - Driver factory and `app()`
* [WindowableApplication](windowable-application.md) - Contract and abstract base
...
* [OSWindow](os-window.md) - Magic alias for `window`
* [Config](config.md) - `config/windows.php`
