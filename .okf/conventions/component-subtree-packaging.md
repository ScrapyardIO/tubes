...
| `Panels/` | `tubes/panels` (requires `tubes/contracts`, `fabricate/nuts-and-bolts`, `gpio/contracts`) — must not import Core |
| `HumanInput/` | `tubes/human-input` (requires `tubes/contracts`, `waveforms/contracts`) — must not import Core |
