...
namespace ScrapyardIO\Tubes\Rendering\Concerns;
...
trait DrawsText
{
    ...
    public function setFont(GFXFont|string|null $f = null): static
    {
     ...
     */
    protected function resolveFontArgument(GFXFont|string|null $f): ?GFXFont
    {
        if (is_null($f)) {
            return null;
        }
